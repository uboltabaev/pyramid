...
const ManDressIcon = React.memo(({width, height, color}) => {
	return (
		<Svg height={height} width={width} viewBox="0 0 407.7 407.7" fill={color}>
			<G>
				<G>
...
ManDressIcon.propTypes = {
    width: PropTypes.number,
    height: PropTypes.number,
    color: PropTypes.string
}

ManDressIcon.defaultProps = {
    color: "#000"
}

export default ManDressIcon;